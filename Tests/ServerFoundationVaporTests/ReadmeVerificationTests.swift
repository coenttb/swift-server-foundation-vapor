...
struct ReadmeVerificationTests {
    ...
    func testHTTPHeaderExtensions() {
        ...
        #expect(HTTPHeaders.Name.xEmailRateLimitRemaining.description == "x-email-ratelimit-remaining")
    ...
    func testRateLimitingMiddlewareTypeExists() {
        ...
        let _: Vapor.Middlewares.Ratelimiting<String>.Type = Vapor.Middlewares.Ratelimiting<String>.self
        #expect(true)
    }
}
#endif
